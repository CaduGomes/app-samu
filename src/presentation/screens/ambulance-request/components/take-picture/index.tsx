...
export const TakePicture: React.FC<Props> = React.memo(
  ({ useAmbulanceRequest, docId }) => {
    ...
    function removeImageFromList() {
      Alert.alert(
        "Remover Imagem",
        "Você deseja remover essa imagem da lista?",
        [
          {
            text: "Cancelar",
            style: "cancel",
    ...
    return (
      <View style={styles.container}>
        ...
        >
          <View style={styles.modalContainer}>
            ...
            <View style={styles.modalRemoveButton}>
              <Pressable onPressIn={removeImageFromList}>
        ...
        <View style={styles.headerContainer}>
          ...
          <Pressable onPressIn={pickImage} hitSlop={30}>
